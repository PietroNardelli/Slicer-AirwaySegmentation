...
=========================================================================*/
#ifndef __itkConnectedThresholdImageFilterModified_h
#define __itkConnectedThresholdImageFilterModified_h
...
class ITK_EXPORT ConnectedThresholdImageFilterModified:
    public ImageToImageFilter<TInputImage,TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef ConnectedThresholdImageFilterModified        Self;
  ...
  itkTypeMacro(ConnectedThresholdImageFilterModified,
               ImageToImageFilter);
...
private:
  ConnectedThresholdImageFilterModified(const Self&); //purposely not implemented
...
#include "itkConnectedThresholdImageFilterModified.hxx"
#endif
